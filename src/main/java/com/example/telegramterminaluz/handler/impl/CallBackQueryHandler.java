...
public class CallBackQueryHandler implements Handler<CallbackQuery> {
    ...
    public void handleMessage(CallbackQuery callbackQuery) throws TelegramApiException {
        ...
        if (callbackQuery.getData().equals(CalendarMarkup.SUBMIT_DATE)) {
            ...
            String command = (String)navigationMenu.getMenus().peek().getBundle().get(Bundle.COMMAND);
            Currency currency = (Currency) navigationMenu.getMenus().peek().getBundle().get(Bundle.CURRENCY);
